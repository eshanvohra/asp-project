...
namespace login2
{
    public partial class telephonebillpay : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "Select Telephone_Bill from Bill where Cust_Id=@custid";
            ...
            if (flag == 1)
            {
                try
                {
                    ...
                    cmd.CommandText = "Select Due_Date_Telephone from Bill where Cust_Id=@custid";
                    ...
                    Label1.Text = "Your Telephone Bill Amount is: " + billamt + " & due date is " + date;
                    Panel1.Visible = true;
                    Button3.Text = "Pay Telephone Bill Worth Rs." + billamt;
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (balance - 500 > billamt)
            {
                ...
                try
                {
                    ...
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandText = "BillPaymentTelephone";
                    cmd.Parameters.AddWithValue("@custid", TextBox1.Text);
                    cmd.ExecuteNonQuery();
                ...
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("@custid", TextBox1.Text);
                    cmd.Parameters.AddWithValue("@creditaccount", "TRAI");
                    ...
                    cmd.Parameters.AddWithValue("@transactiondetails", "Telephone Bill Payment");
                    cmd.ExecuteNonQuery();
                ...
                string body = " Your recent Telephone Bill worth Rs." + billamt + " has been paid successfully.";
