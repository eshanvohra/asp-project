...
namespace login2
{
    ...
    public partial class Debit_Card_Request : System.Web.UI.Page
    {
        static string name = "";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string service = "Debit_Card_Type_" + DropDownList1.Text + "_Mode_" + RadioButtonList1.Text;
                ...
                //sending email
                string subject = "Debit Card Requested";
                string body = "You have successfully placed Debit Card request.This request will be processed " +
