        ...
        <div id="ImageSlider" class="carousel slide" data-ride="carousel">
          <ol class="carousel-indicators imp">
            ...
            <li data-target="#ImageSlider" class="bg-info" data-slide-to="2"></li>
              <li data-target="#ImageSlider" class="bg-info" data-slide-to="3"></li>
              <li data-target="#ImageSlider" class="bg-info" data-slide-to="4"></li>
              <li data-target="#ImageSlider" class="bg-info" data-slide-to="5"></li>
          </ol>
